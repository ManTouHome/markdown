...
![](../../img/collections/current01.png)

### 3.ConcurrentHashMap测试
...
![](../../img/collections/Cow01.png)

![](../../img/collections/cow02.png)

#### 2.CopyOnWriteArrayList

底层： 基于数组实现的，因为addIfAbsent方法需要循环比较是不是数组中已经存在该元素，所以效率低。
...
底层：基于CopyOnWriteArrayList实现，add方法底层就是addIfAbsent()方法，所以效率低于CopyOnWriteArrayList
...
![](../../img/collections/block.png)

API:

![](../../img/collections/blockqueueapi.png)
...
![](../../img/collections/arrayblockingqueue02.png)

#### 3.LinkedBlockingQueue队列

特点：支持读写同时操作，并发情况下，效率高。底层基于链表。

put阻塞：

![](../../img/collections/putblock.png)
...
![](../../img/collections/synqueue.png)

![](../../img/collections/synqueue02.png)

注意：取出元素不能用peek,因为peek只是查看不会取出数据。
...
![](../../img/collections/delayqueue.png)
